...
public class WolfSchedulerTest {
	...
	public void testCheckConflictEvent() {
		...
		Exception e = assertThrows(IllegalArgumentException.class, () -> 
			ws.addEventToSchedule("Breakfast", "MTWHF", 700, 800, "Yummy time!"));
	 ...
	 */
	@Test
	public void testCheckConflictCourse() {
		WolfScheduler ws = new WolfScheduler(validTestFile);
	...
	public void testGetScheduledActivities() {
		...
		Exception e = assertThrows(IllegalArgumentException.class, () -> ws.addCourseToSchedule("CSC 116", "002"));
    	assertEquals("The course cannot be added due to a conflict.", e.getMessage());
